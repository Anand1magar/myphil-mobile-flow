...
export function Select({ label, options = ['Item 1', 'Item 2', 'Item 3'], value, onChange, placeholder = 'Select an option' }) {
  ...
  return (
    <div style={{ width: 288, fontFamily: 'var(--font-body)', position: 'relative' }}>
      ...
      <div onClick={() => setOpen(o => !o)} style={{ height: 48, borderRadius: 4, boxShadow: '0 0 0 1px var(--pitch)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '8px 16px', cursor: 'pointer' }}>
