...
const HOW_IT_WORKS = [
  'Phil partners with the makers of SYMBRAVO® (meloxicam and rizatriptan) to make it easy for patients to access their medications.',
  'Phil partners with the makers of SYMBRAVO® (meloxicam and rizatriptan) to make it easy for patients to access their medications.',
    ...
    <div style={{ width: '100%', background: '#fff', display: 'flex', flexDirection: 'column', alignItems: 'center', fontFamily: 'var(--font-body)' }}>
      ...
      <div style={{ width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: 28, padding: '20px 16px' }}>
        ...
        <p style={{ fontSize: 16, lineHeight: '24px', color: 'var(--pitch)', margin: 0 }}>
          Your SYMBRAVO® (meloxicam and rizatriptan) is ready! Dr. Cristina Truman sent your prescription to Axsome OnMySide Direct.
        </p>
        ...
        <Button hierarchy="primary" fullWidth disabled={!canContinue} onClick={() => navigate('/insurance-details')}>Next</Button>
      </div>
      ...
      <div style={{ width: '100%', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', gap: 20, padding: '0 16px 20px' }}>
        ...
        <p style={{ fontSize: 16, lineHeight: '24px', color: 'var(--pitch)', margin: 0 }}>
          Already have an Axsome OnMySide account? <a href="#" style={{ color: 'var(--sky)', fontWeight: 700 }}>Log in</a>
        </p>
