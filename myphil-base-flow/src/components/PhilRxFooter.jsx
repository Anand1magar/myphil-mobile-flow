...
export function PhilRxFooter({ insuranceNote = false }) {
  return (
    <div style={{ width: '100%', background: '#fff', borderTop: '0.5px solid #e6e6e6', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 16, padding: '16px 16px 28px' }}>
      {insuranceNote && (
